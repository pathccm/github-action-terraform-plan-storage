...
var credentialProviderLogin = __webpack_require__(95824);

const resolveCredentialSource = (credentialSource, profileName, logger) => {
    const sourceProvidersMap = {
        EcsContainer: async (options) => {
            const { fromHttp } = await __webpack_require__.e(/* import() */ 290).then(__webpack_require__.bind(__webpack_require__, 17290));
        ...
        Environment: async (options) => {
            ...
            const { fromEnv } = await Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 15972, 19));
...
const resolveProcessCredentials = async (options, profile) => __webpack_require__.e(/* import() */ 969).then(__webpack_require__.t.bind(__webpack_require__, 89969, 19)).then(({ fromProcess }) => fromProcess({
    ...options,
    profile,
...
const resolveSsoCredentials = async (profile, profileData, options = {}, callerClientConfig) => {
    const { fromSSO } = await __webpack_require__.e(/* import() */ 414).then(__webpack_require__.t.bind(__webpack_require__, 26414, 19));
    return fromSSO({
        profile,
...
const isWebIdentityProfile = (arg) => Boolean(arg) &&
    ...
    typeof arg.role_arn === "string" &&
    ["undefined", "string"].indexOf(typeof arg.role_session_name) > -1;
const resolveWebIdentityCredentials = async (profile, options, callerClientConfig) => Promise.all(/* import() */[__webpack_require__.e(273), __webpack_require__.e(646)]).then(__webpack_require__.t.bind(__webpack_require__, 15646, 23)).then(({ fromTokenFile }) => fromTokenFile({
...
var node_os = __webpack_require__(70612);
var node_path = __webpack_require__(49411);
...
class LoginCredentialsFetcher {
    ...
    async refresh(token) {
        const { SigninClient, CreateOAuth2TokenCommand } = await __webpack_require__.e(/* import() */ 747).then(__webpack_require__.t.bind(__webpack_require__, 53747, 23));
